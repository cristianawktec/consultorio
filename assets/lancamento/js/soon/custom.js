...
(function($) {
    ...
    **/
    var launch = new Date(2016, 04, 13, 14, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('<b>Acompanhe aqui o nosso Lançamento! </br>');
        }
        else{
            ...
            message.html('<b>Acompanhe aqui o nosso Lançamento!<br>Para o dia 13 de Maio!</br>');
        }
    }
})(jQuery);
/******************************************************************************************************************************
