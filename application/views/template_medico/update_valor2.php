            ...
            <div class="col-md-9 col-sm-7">
                <div class="contact-caption clearfix" style="width: 75%">
                    ...
                    <div class="col-md-12 col-md-offset-1 contact-form" style="margin-left: 0px !important;">
                        <h3>Atualizar Valor Consulta</h3>

                        <form class="form" method="post" action="/medico/atualizar_valor2/<?=$valor[0]->id_usuario;?>">
                            <div class="input-group xs-mb-15"><span class="input-group-addon">R$</span>
                                <input class="form-control" type="text" name="vr_consulta2" id="vr_consulta2" placeholder="Informe o Valor da Consulta" style="width: 45%" value="<?php echo $valor[0]->vr_consulta2;?>">
                            </div>
