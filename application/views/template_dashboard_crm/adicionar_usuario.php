    ...
    <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                ...
                <div class="page-title"><span>Adicionar Usuário</span></div>
            ...
            <div class="row">
                <div class="col-sm-6" style="width: 530px;">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Adicionar Usuário<span class="panel-subtitle">Adição Usuário CRM</span></div>
                        <div class="panel-body">
                            <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/usuario/adicionar/">
                                <div class="form-group xs-pt-10">
                                    <label>Nome</label>
                                    <input type="nome" name="nome" id="nome" placeholder="Entre com o nome do Usuário" class="form-control">
                                </div>
                                <div class="form-group xs-pt-10">
                                    <label>Usuario</label>
                                    <input type="usuario" name="usuario" id="usuario" placeholder="Entre com login do usuário" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Senha</label>
                                    <input type="password" name="senha" id="senha" placeholder="Informe a senha do usuário" class="form-control">
                                </div>
                                <div class="form-group">
