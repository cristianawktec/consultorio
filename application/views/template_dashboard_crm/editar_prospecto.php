        ...
        <div class="row">
            <div class="col-sm-12" style="width: 780px;">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Editar Prospecto<span class="panel-subtitle">Edição Prospecto CRM</span></div>
                    <div class="panel-body">
                        <?php foreach($registros as $dados) {?>
                        <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/prospecto/atualizar/">
                            <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $dados->id; ?>">
                            <input class="text" type="hidden" name="id_perfil" value="1">
                            <div class="form-group">
                                <div class="col-sm-12" >
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Nome do Paciente</label>
                                        <input type="text" name="nome" id="nome" value="<?php echo $dados->nome; ?>" class="form-control">
                                    </div>
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Nome do Responsável</label>
                                        <input type="text" name="nm_responsavel" id="nm_responsavel" value="<?php echo $dados->nm_responsavel; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        ...
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Contato</label>
                                            <input type="text" name="nr_contato" id="nr_contato" value="<?php echo $dados->nr_contato; ?>" class="form-control">
                                        </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        ...
                                        <input size="16" type="text" name="data_cadastro" id="data_cadastro" class="form-control" value="<?php echo $dados->data_cadastro;?>" disabled=false>
                                    </div>
                                    <div class="be-checkbox inline" style="width: 300px;" >
                                        <div class="col-sm-6" style="height: 31px; width: 202px;">
                                            <label>Origem</label>
                                            <select class="select2" name="fonte" id="fonte">
                                                <option value="<?php echo $dados->fonte; ?>"><?php echo $dados->fonte; ?></option>
