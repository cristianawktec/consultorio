    ...
    <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                ...
                <div class="page-title"><span>Editar Lembrete</span></div>
        ...
        <div class="row">
            <div class="col-sm-12" style="width: 780px;">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Editar Lembrete<span class="panel-subtitle">Edição Lembrete CRM</span></div>
                    <div class="panel-body">
                        <?php foreach($registros as $dados) {
                        $data2 = explode('-', $dados->lembrete_data);
                        $dados->lembrete_data = $data2['2']."/".$data2['1']."/".$data2['0'];
                        ?>
                        <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/dashboard/atualizar_lembrete/">
                            <input type="hidden" name="lembrete_id" id="lembrete_id" class="form-control" value="<?php echo $dados->lembrete_id; ?>">
                            <div class="form-group">
                                <div class="col-sm-12" >
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Título</label>
                                        <input type="text" name="lembrete_titulo" id="lembrete_titulo" value="<?php echo $dados->lembrete_titulo; ?>" class="form-control">
                                    </div>
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Data</label>
                                        <input type="text" name="lembrete_data" id="lembrete_data" value="<?php echo $dados->lembrete_data; ?>" class="form-control">
                                    </div>

                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Horario</label>
                                        <input type="text" name="lembrete_hora" id="lembrete_hora" value="<?php echo $dados->lembrete_hora.":".$dados->lembrete_minuto." hs"; ?>" class="form-control">
                                    </div>
                                    <div class="be-checkbox inline" style="width: 300px;">
                                        <label>Lembrete</label>
                                        <input type="text" name="lembrete_mensagem" id="lembrete_mensagem" value="<?php echo $dados->lembrete_mensagem; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
