...
$id = $_SESSION['usuarioCrm']->id;
$nome = $_SESSION['usuarioCrm']->nome;
$usuario = $_SESSION['usuarioCrm']->usuario;
$senha = $_SESSION['usuarioCrm']->senha;
$nivel = $_SESSION['usuarioCrm']->nivel;
    ...
    <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                ...
                <div class="page-title"><span>Alterar Senha</span></div>
            ...
            <div class="row">
                <div class="col-sm-6" style="width: 530px;">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Alterar Senha<span class="panel-subtitle">Edição Usuário CRM</span></div>
                        <div class="panel-body">
                            <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/usuario/atualizar/">
                                <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $id; ?>">
                                <input type="hidden" name="nivel" id="nivel" class="form-control" value="<?php echo $nivel; ?>">
