...
<script>
    ...
    function busca_cidades(cod_estados){//alert(cod_estados);alert(base_url);
        $.post(base_url+"index.php/PacienteCrmController/busca_cidades_estado", {
            cod_estados
        }, function(data){
            $('#nm_cidade').html(data);
        });
            ...
            <div class="row">
                <div class="col-sm-12" style="width: 780px;">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Adicionar Paciente<span class="panel-subtitle">Adição Paciente CRM</span></div>
                        <div class="panel-body">
                            <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/paciente/adicionar">
                                <input class="text" type="hidden" name="id_perfil" value="1">
                                <div class="form-group">
                                    <div class="col-sm-12" >
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Nome do Paciente</label>
                                            <input type="text" name="nm_paciente" id="nm_paciente" placeholder="Entre com o nome do Paciente" class="form-control">
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Nome do Responsável</label>
                                            <input type="text" name="nm_mae" id="nm_mae" placeholder="Entre com o nome do Responsável" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>E-mail</label>
                                            <input type="text" name="ds_email" id="ds_email" placeholder="Entre com o email do Paciente" class="form-control">
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Data de Nacimento</label>
                                                <div data-min-view="2" data-date-format="dd/mm/yyyy" class="input-group date datetimepicker">
                                                    <input size="16" type="text" name="dt_nascimento" id="dt_nascimento" value="" class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            ...
                                            <input type="text" name="nr_telefone" id="nr_telefone" placeholder="Informe um telefone fixo" class="form-control">
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Celular</label>
                                            <input type="text" name="nr_celular" id="nr_celular" placeholder="Informe um número de celular" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            ...
                                            <input type="text" name="nm_endereco" id="nm_endereco" placeholder="Informe o endereço" class="form-control">
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Bairro</label>
                                            <input type="text" name="nm_bairro" id="nm_bairro" placeholder="Informe o Bairro" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>CEP</label>
                                            <input type="text" name="nr_cep" id="nr_cep" placeholder="Informe o CEP" class="form-control">
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;" >
                                            <div class="col-sm-6" style="height: 31px; width: 202px;">
                                                <label>Origem</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Data de Cadastro</label>
                                                <input size="16" type="text" name="dt_cadastro" id="dt_cadastro" class="form-control" value="<?php echo $dateTime;?>" disabled=false>
                                        </div>
                                        <div class="be-checkbox inline" style="width: 300px;">
                                            <label>Última modificação</label>
                                                <input size="16" type="text" name="dt_modificacao" id="dt_modificacao" class="form-control" value="<?php echo $dateTime;?>" disabled=false>
                                        </div>
                                    </div>
                                </div>
                                <br><br><br><br><p/>
