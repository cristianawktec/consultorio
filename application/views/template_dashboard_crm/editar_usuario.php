...
//echo"<pre>view";print_r($dados);echo"</pre>";exit
?>
    ...
    <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                ...
                <div class="page-title"><span>Editar Usuário</span></div>
            ...
            <div class="row">
                <div class="col-sm-6" style="width: 530px;">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Editar Usuário<span class="panel-subtitle">Edição Usuário CRM</span></div>
                        <div class="panel-body">
                            <?php foreach($registros as $dados) { ?>
                            <form id="myForm" name="myForm" class="form" method="post" action="<?=base_url()?>crm/usuario/atualizar/">
                                ...
                                <div class="form-group xs-pt-10">
                                    <label>Usuario</label>
                                    <input type="text" name="usuario" id="usuario" class="form-control"  value="<?php echo $dados->usuario; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Senha</label>
                                    <input type="password" name="senha" id="senha" class="form-control"  value="<?php echo $dados->senha; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Nível</label>
                                    <div class="col-sm-6">
                                        <select class="select2" name="nivel">
                                                <!--<option value="">Selecione um Nível</option>-->
                                                <option value="<?php echo $dados->nivel; ?>">Administrador</option>
                                                <option value="<?php echo $dados->nivel; ?>">Usuario</option>
                                        </select>
                                    </div>
                                </div>
                                <br><br><br>
                                <div class="row xs-pt-15">
                                    <div class="col-xs-6"  style="width: 70%;">
                                        <p class="text-right">
                                            ...
                                            <button class="btn btn-space btn-default" onClick="history.back()">Cancelar</button>
                                        </p>
                                    </div>
                                </div>
                                <?php } ?>
