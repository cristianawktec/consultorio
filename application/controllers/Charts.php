...
class Charts extends CI_Controller {
    ...
    function index()
    {
        ...
        $serie = array();
        // some data series
        $serie['data'] = $this->charts_model->medicos();
        $data['charts'] = $this->highcharts->set_serie($serie)->render();
        $this->view_data['serie'] = json_encode($serie);
        $this->load->view("template_dashboard_admin/index", $this->view_data);
        //$this->load->view("template_dashboard_admin/index", $serie);
    }
