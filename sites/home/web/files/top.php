...
<head>
    ...
    <meta name="description" content="Medipro | Responsive HTML5 Medical Template">
...
/*
 * Title:   Medipro | Responsive HTML5 Medical Template - Main CSS file
...
@media all and (min-width: 0px) and (max-width: 767px) {
  ...
  /* END OF MOBILE STYLING */
    ...
    <!-- Custom Style -->
    <link href="custom.less" rel="stylesheet" type="text/less"><style type="text/css" id="less:medipro-v2-demos-html-less-custom">/*
 ...
 */
    ...
    <!-- Updates Style -->
    <link href="updates.less" rel="stylesheet" type="text/less"><style type="text/css" id="less:medipro-v2-demos-html-less-updates">/*
