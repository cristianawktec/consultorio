...
$query_cli = mysql_query("SELECT * FROM clientes ORDER BY cliente_id DESC");
...
<input type="text" name="tel_fixo3" id="tel_fixo3" class="texto1" maxlength="14" />
  ...
  <tr>
    ...
    <input type="text" name="cidade2" id="cidade2"  class="texto" />
      <input type="text" name="cidade3" id="cidade3" class="texto" /></td>
...
<option value="TO">TO</option>
    ...
    <td><label>Cidade</label><br />
      ...
      <input type="text" name="cidade4" id="cidade4" class="texto" />
      <input type="text" name="cidade5" id="cidade5" class="texto" />
      <input type="text" name="cidade6" id="cidade6"class="texto" /></td>
    <td><label>UF</label><br />
