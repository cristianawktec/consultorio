...
//CONTINUAR DAQUI
if($nivel == '0'){
$query = mysql_query("SELECT * FROM prospectos where prospecto_atendente_id = '$atendente' ORDER BY prospecto_id DESC");
...
if($nivel == '0'){
$query2 = mysql_query("SELECT * FROM prospectos where prospecto_atendente_id = '$atendente' ORDER BY prospecto_nome ASC");
} else

if($nivel == '1'){
$query2 = mysql_query("SELECT * FROM prospectos ORDER BY prospecto_nome ASC");
}
...
$pdf->SetY(50);
$pdf->SetX(240);
$pdf->Cell(0,5,$row2["prospecto_nome"],0,1,'L');
