...
<head>
    ...
    <meta name="description" content="Ebook-faltas ClickConsultorio">
                    ...
                    <div class="row">
                        <div class="col-sm-7 col-xs-12">
                            <div class="banner-text">
                              ...
                              <!-- EBOOK -->
                                  <img src="files/ebook.png" alt="" class="img-ebook">
                              <!-- END OF EBOOK -->
...
<section class="opening-hour-style1" id="opening-hour-section">
    <div class="container">
        <label>
          Pacientes faltam por diversos motivos à suas consultas<br>
          e esta é uma dificuldade comum entre os profissionais da saúde.<br>
          O paciente que falta à consulta, não avisa e nem dá sinal de vida <br>
          e o horário que você poderia encaixar e atender um outro paciente fica ocioso. <br>
          Logo, você perde tempo e dinheiro. Um primeiro passo para evitar este tipo de
          incômodo é conhecer as principais razões por quais os pacientes não comparecem <br>
          às suas consultas. Isso é um grande pesadelo para todos os profissionais de saúde <br>
          e aprofundamos  este assundo em nosso ebook! Faça já o seu Download! é Grátis!
        </label>
        <h2></h2>
        <!--
