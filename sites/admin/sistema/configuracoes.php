...
header('Content-Type: text/html; charset=utf-8');
	...
	$hostname = "ClickConsultorio";//trim(shell_exec('hostname'));

	define(@HOSTNAME, $hostname);

	if (@HOSTNAME == 'ClickConsultorio') {
		define(@USAR_BD, true);
    ...
    define(HTML_TITLE, 'Sistema Web AwkAdmin');
    define(HTML_TITLE_POPUP, 'Sistema Web Awk popup');
    define(CABECALHO,HTML_TITLE);
    define(RODAPE,'AWK - Florian&oacute;polis');
    define(VERSAO,'3.2.1');
	define(COR01,'#effaFF');
	define(COR02,'#dFEEEE');
