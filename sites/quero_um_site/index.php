      ...
      <div class="header-content">
        <div class="container">
          ...
          <div class="row">
            ...
            <h1 style="font-family: 'proxima_nova';color: #c22019;font-size: 24px;text-align: center;font-weight: bold; line-height: 0px;">
              Como Atrair Mais Pacientes Para o Seu Consultório?</h1>
            <h3 style="font-family: 'proxima_nova';color: #616161;font-size: 20px;text-align: center;font-weight: normal;">
              Sem gastar um só centavo!</h3>

            <div class="col-sm-7 col-xs-12">
              <div class="banner-text">

                <!-- EBOOK -->
                <img src="files/capa.png" alt="" class="img-ebook" style="max-width: 90%;width: 71%;">
                <!-- END OF EBOOK -->
            ...
            <div class="col-sm-5 col-xs-12">
              ...
              <div class="banner-form animated fadeInUp" style="visibility: visible;">
                <h3 style="
                                  ...
                                  color: #424040;
                                  text-align: center;
                              ">Confira o que o ClickConsutório preparou para você.</h3>
                ...
                <form id="form" name="form" method="post" action="cadastra.php">
                  ...
                  <input type="submit" value="FAZER DOWNLOAD" class="btn">
                </form>
              </div>
              <!-- END OF HEADER FORM-->
            </div>
